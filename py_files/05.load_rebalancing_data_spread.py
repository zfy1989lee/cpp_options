...
def LoadTxtFile(filename):
    #filename = "../reports/eurusd_1m_25callspr_00_750/report_7_2009-05-13_2009-05-20.txt"
            ...
            for volspread in volspreads:
                ...
                for threshold in thresholds:
                    for (cycle_id, cycle_start,cycle_end) in cycles_results:
                        #filename = "../reports/eurusd_1m_25callspr_00_750/report_7_2009-05-13_2009-05-20.txt"
                        txt_filename = "../reports/%s_%s_%s%sspr_%s_%s/report_%s_%s_%s.txt" % (ccypair,tenor,delta,opttype,volspread,threshold,cycle_id,str(cycle_start),str(cycle_end))
                        if not os.path.exists(txt_filename):
                            ...
                            for i in txt_df.index:
                                sql_query = "INSERT INTO rebalancing_data_spreads %s VALUES (%s,\"%s\",\"%s\",%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,\"%s\",\"%s\",\"%s\",\"%s\");" % (insert_into_cols, cycle_id, txt_df.ix[i,"reb_date"], txt_df.ix[i,"reb_time"], txt_df.ix[i,"reb_spot"], txt_df.ix[i,"reb_spot_chg_pips"], txt_df.ix[i,"reb_step_pips"],txt_df.ix[i,"reb_slippage_pips"],txt_df.ix[i,"reb_no_orders_hit"], txt_df.ix[i,"reb_delta_hedge"],txt_df.ix[i,"reb_unhedged_delta"],txt_df.ix[i,"reb_delta_pnl"], txt_df.ix[i,"reb_total_delta_pnl"],txt_df.ix[i,"reb_option_price_change"], txt_df.ix[i,"reb_portfolio_pnl"],txt_df.ix[i,"reb_total_portfolio_pnl"], txt_df.ix[i,"reb_delta"],txt_df.ix[i,"reb_gamma"],txt_df.ix[i,"reb_theta"],txt_df.ix[i,"reb_xgamma"], txt_df.ix[i,"option_price"],threshold,tenor,ccypair,opttype,volspread)
